                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <button wire:click="openModal"
                                class="w-full flex items-center justify-center space-x-2 bg-blue-600 text-white px-4 py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            ...
                            <button
                                class="w-full flex items-center justify-center space-x-2 bg-gray-100 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-200 transition-colors duration-200">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="p-6">
                        <form wire:submit.prevent="save" class="space-y-5">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Optional field for contact purposes</p>
                            </div>
