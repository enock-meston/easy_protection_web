    ...
    <section class="py-1 bg-gradient-to-br from-slate-50 via-white to-blue-50 relative overflow-hidden">
        <div class="py-10 relative z-10">
            <div class="max-w-7xl mx-auto py-8 px-4">
                ...
                @if ($products->count())
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @foreach ($products as $product)
                            <div
                                class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hover:border-blue-200 transition-all duration-300">
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-xs text-gray-600 mb-2">Rwf {{ number_format($product->price, 2) }}
                                    </p>
                ...
                @else
                    <div class="text-gray-500 text-lg font-medium py-12 text-center">No products found in this category.
                    </div>
                @endif
            </div>
        </div>
