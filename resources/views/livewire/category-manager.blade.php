...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Manage your product categories and their settings</p>
        </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $categories->where('status', 'inactive')->count() }}</p>
                </div>
            </div>
        </div>
                    ...
                    @forelse ($categories as $index => $cat)
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <code class="bg-gray-100 px-2 py-1 rounded text-xs">{{ $cat->slug }}</code>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $cat->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                ...
                <div class="inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <div class="bg-white px-6 pt-6 pb-4">
                        <div class="flex items-center justify-between mb-6">
                            <h3 class="text-lg font-semibold text-gray-900" id="modal-title">
                                {{ $categoryIdBeingUpdated ? 'Edit Category' : 'Create New Category' }}
                            </h3>
                            <button wire:click="$set('showModal', false)" class="text-gray-400 hover:text-gray-600 transition-colors duration-150">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-gray-400 transition-colors duration-150">
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
                        ...
                        <button wire:click="save"
                            ...
                            {{ $categoryIdBeingUpdated ? 'Update Category' : 'Create Category' }}
                        </button>
                    </div>
                </div>
            </div>
